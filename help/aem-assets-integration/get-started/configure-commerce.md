...
- Verificare che RabbitMQ sia abilitato e in ascolto degli eventi.
   - [Configurazione di RabbitMQ per Adobe Commerce on-premise](https://experienceleague.adobe.com/en/docs/commerce-cloud-service/user-guide/configure/service/rabbitmq)

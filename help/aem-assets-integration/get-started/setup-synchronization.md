...
* Per abilitare [Dynamic Media con funzionalità OpenAPI](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/assets/dynamicmedia/dynamic-media-open-apis/dynamic-media-open-apis-overview#enable-dynamic-media-open-apis) su AEM as a Cloud Service, invia un ticket di supporto Adobe con le seguenti informazioni:

   * Title: Abilita Dynamic Media OpenAPI per un’integrazione completa tra Adobe Commerce e AEM Assets/Visualizzazioni di prodotti basati su AEM Assets

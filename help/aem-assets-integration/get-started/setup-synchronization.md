...
1. [Abilitare Adobe IMS per Commerce](https://experienceleague.adobe.com/docs/commerce-admin/start/admin/ims/adobe-ims-config.html){target=_blank} seguendo le istruzioni contenute nella *Guida per l&#39;amministratore di Commerce*.

...
- Rivedi le regole di merchandising per garantire la promozione dei prodotti con margini elevati
- Analizza le prestazioni di ricerca per identificare se i prodotti più popolari sono ancora classificati bene
...
- Verifica la rilevanza dei risultati di ricerca e implementa i sinonimi se necessario
...
- [Sinonimi](../merchandising/synonyms/overview.md) - Miglioramento della rilevanza della ricerca e dell&#39;esperienza del cliente
- [Panoramica degli eventi](../setup/events/overview.md) - Comprendere i dati che alimentano le metriche

...
- Gestione dei risultati {#manage-results}
  ...
  - {hide-from-toc}[Ricerca corrispondenza e classificazione](./manage-results/search-relevance-matching.md)
...
- Configurazione store {#setup}
  - [Origini del catalogo](./setup/catalog-sources.md)
  - [Visualizzazioni catalogo](./setup/catalog-view.md)
  - [Visualizzazioni di cataloghi privati](./setup/private-catalog-view.md)
  - [Chiavi di accesso con restrizioni](./setup/restricted-access-keys.md)
...
- Sito di lancio {#launch}
  - [Elenco di controllo di Launch](./launch/launch-checklist.md)

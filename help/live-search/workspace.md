...
[!DNL Live Search] rispetta anche il [peso](https://experienceleague.adobe.com/en/docs/commerce-admin/catalog/catalog/search/search-results#weighted-search) di un attributo di prodotto, come impostato in Adobe Commerce. Gli attributi con un peso maggiore appariranno più in alto nei risultati di ricerca.
...
>[!TIP]
>
>La scelta degli attributi da rendere ricercabili ha un grande impatto sulla qualità della ricerca. Consulta [Sfruttare i metadati del prodotto](best-practice.md#leverage-product-metadata) nella guida alle best practice per informazioni dettagliate sulla selezione degli attributi ricercabili e sull&#39;eliminazione dei problemi di configurazione comuni.
...
I seguenti attributi di prodotto hanno [proprietà storefront](https://experienceleague.adobe.com/en/docs/commerce-admin/catalog/product-attributes/product-attributes) utilizzate da [!DNL Live Search] e abilitate per impostazione predefinita.

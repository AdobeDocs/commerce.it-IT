...
![Correzione](../assets/fix.svg) Nella vetrina, il collegamento a piè di pagina [Termini di ricerca](https://experienceleague.adobe.com/en/docs/commerce-admin/catalog/catalog/search/search-terms) è stato rimosso e la relativa cache disabilitata per le installazioni di [!DNL Live Search].

...
>[!IMPORTANT]
>
>L’OTC del codice monouso generato è valido per 30 secondi per impostazione predefinita e viene invalidato dopo un singolo utilizzo. Il TTL può essere configurato tramite CPS utilizzando l&#39;impostazione `customer/otp/ttl_seconds`.

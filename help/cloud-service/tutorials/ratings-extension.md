...
1. Osserva le modifiche nella base di codice e controlla la pagina del prodotto per gli aggiornamenti.
   ...
   * Il componente è integrato nel PDP utilizzando [slot di rilascio](https://experienceleague.adobe.com/en/tools/commerce-storefront/dropins/customize/slots/) o come blocco autonomo, a seconda dell&#39;architettura scelta.

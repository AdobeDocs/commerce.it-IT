...
Il servizio RAG fa parte del server [Commerce extensibility tools](https://developer.adobe.com/commerce/extensibility/developer-agent/coding-tools/){target="_blank"} MCP (Model Context Protocol), che si integra con Cursor e altri assistenti di IA compatibili con MCP.
...
|-------|---------|---------|------------------------|
| [Vetrina](https://experienceleague.adobe.com/en/tools/commerce-storefront/) | commerce-storefront-docs | Edge Delivery Services, drop-in, componenti storefront | vetrina, consegna, EDS, elenco prodotti, pagamento |

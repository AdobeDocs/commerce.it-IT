...
# Guida di [!DNL Data Export] per i servizi SaaS {#saas-data-export}

- [Panoramica della guida](overview.md)
- Sincronizzare i dati {#data-synchronization}
   - [Funzionamento della sincronizzazione](sync-overview.md)
   - [Gestire la sincronizzazione](data-sync-manage.md)
   - [Meccanismo di blocco dell’alimentazione](feed-lock-mechanism.md)
...
- Estensibilità {#extensibility}
   ...
   - [Aggiungere dinamicamente attributi di prodotto](add-attribute-dynamically.md)
...
- Risoluzione dei problemi {#troubleshooting}
   ...
   - [Riferimento codici di registro](troubleshooting/log-codes-reference.md)

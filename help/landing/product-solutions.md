...
>[!NOTE]
>
>Per ulteriori informazioni sulle funzionalità disponibili in [!DNL Adobe Commerce as a Cloud Service] (SaaS) e sull&#39;allineamento di tali funzionalità con altre versioni di Adobe Commerce, ad esempio [!DNL Adobe Commerce on Cloud] e [!DNL Adobe Commerce on Premises] (PaaS), vedere [Confronto delle funzionalità](../cloud-service/feature-comparison.md).

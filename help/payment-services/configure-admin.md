...
1. I valori **[!UICONTROL Payment Services Sandbox ID]** e **[!UICONTROL Payment Services Production ID]** vengono compilati automaticamente dopo aver configurato [Commerce Services Connector](../landing/saas.md){target=_blank} e aver visitato il dashboard [!DNL Payment Services] per la prima volta. Esegui questa operazione per completare l’onboarding per gli ambienti sandbox e/o di produzione. Questi valori associano il tuo ID SaaS a [!DNL Payment Services].
...
Nelle versioni precedenti, la mappatura dell&#39;account PayPal a livello di sito Web richiedeva in genere di [contattare il supporto](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide#support-case) o il rappresentante Adobe. Utilizzare l&#39;azione **[!UICONTROL Connect different account]** quando si soddisfano i prerequisiti seguenti.

### Prerequisiti (ambito globale)

Il controllo **[!UICONTROL Connect different account]** è disponibile e abilitato solo in un ambito **sito Web** quando **tutti** dei seguenti valori sono già true per l&#39;istanza nella configurazione **default/global**:

1. Installazione di [Commerce Services Connector](../landing/saas.md) completata.
...
1. Un account esercente PayPal **globale** è **connesso** e hai **completato l&#39;onboarding PayPal** per l&#39;ambito predefinito (i campi **[!UICONTROL PayPal Merchant ID]** e correlati sono compilati per l&#39;ambito globale come descritto in [Configurazione generale](#general-configuration)).
   ...
   Se l&#39;onboarding globale non è completo, passa l&#39;ambito di configurazione a **[!UICONTROL Website]**, apri **[!UICONTROL Payment Services]** in **[!UICONTROL Payment Methods]** e il pulsante **[!UICONTROL Connect different account]** è **disabilitato**; completa la configurazione del connettore e **global** prima l&#39;onboarding PayPal.
...
Per ulteriori informazioni, vedere [Opzioni di pagamento](payments-options.md#paypal-payment-buttons).
...
| [!UICONTROL Payment Action] | sito web | [azione di pagamento](https://experienceleague.adobe.com/en/docs/commerce-admin/config/sales/payment-methods/payment-methods) per il metodo di pagamento specificato. Opzioni: [!UICONTROL Authorize] / [!UICONTROL Authorize and Capture] |
...
1. Nel pannello a sinistra, espandi **[!UICONTROL Sales]** e scegli **[!UICONTROL Payment Methods]**.
1. Espandere la sezione _[!UICONTROL FEATURED ADOBE PAYMENT SOLUTION]_.
1. Nella sezione _[!UICONTROL [!DNL Payment Services]]_, espandere la sezione_[!UICONTROL Apple Pay]_.
1. Per **[!UICONTROL Title]**, immettere il testo (se necessario) per modificare il nome del metodo di pagamento come mostrato durante l&#39;estrazione.
...
1. Nel pannello a sinistra, espandi **[!UICONTROL Sales]** e scegli **[!UICONTROL Payment Methods]**.
1. Espandere la sezione _[!UICONTROL FEATURED ADOBE PAYMENT SOLUTION]_.
1. Nella sezione _[!UICONTROL [!DNL Payment Services]]_, espandere la sezione_[!UICONTROL Google Pay]_.
...
Consulta [Ruoli utente](https://experienceleague.adobe.com/en/docs/commerce-admin/systems/user-accounts/permissions-user-roles) per scoprire come gestire i ruoli.
...
Per ulteriori informazioni sulla gerarchia di siti Web, store e visualizzazioni dello store, vedere [Ambito sito, archivio e visualizzazione](https://experienceleague.adobe.com/en/docs/commerce-admin/start/setup/websites-stores-views).

Per connettere un **account PayPal diverso a un singolo sito Web** dall&#39;amministratore dopo il completamento dell&#39;onboarding di **global** Servizi Commerce e PayPal, utilizzare **[!UICONTROL Connect different account]** nell&#39;ambito **[!UICONTROL Website]**. Consulta [Collegare un account PayPal diverso per un sito Web](#connect-a-different-paypal-account-for-a-website).

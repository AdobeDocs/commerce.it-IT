...
- [AEM](https://experienceleague.adobe.com/it/docs/experience-manager-cloud-service/content/content-and-commerce/cif-storefront/integrations/aep)
...
- [Adobe Client Data Layer (ACDL)](https://experienceleague.adobe.com/it/docs/experience-platform/tags/extensions/client/client-data-layer/overview), necessario per raccogliere i dati evento storefront
...
1. Assicurati di disporre dell&#39;autorizzazione [per la raccolta dati in Experience Platform](https://experienceleague.adobe.com/it/docs/experience-platform/collection/permissions).
...
1. [Crea un set di dati](https://experienceleague.adobe.com/it/docs/platform-learn/implement-mobile-sdk/experience-cloud/platform#create-a-dataset) in base allo schema creato o aggiornato. Questo set di dati contiene i dati Commerce inviati ad Experience Platform Edge.
1. [Crea un flusso di dati](https://experienceleague.adobe.com/it/docs/experience-platform/datastreams/overview) e seleziona lo schema XDM che contiene i gruppi di campi specifici di Commerce.
...
- [Centro assistenza](https://experienceleague.adobe.com/it/docs/commerce-knowledge-base/kb/overview){target="_blank"}

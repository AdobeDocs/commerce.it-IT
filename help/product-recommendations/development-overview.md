...
I consigli di prodotto sono un potente strumento di marketing che puoi utilizzare per aumentare le conversioni, incrementare i ricavi e stimolare il coinvolgimento degli acquirenti. I consigli di prodotto vengono visualizzati sulla vetrina sotto forma di unità quali &quot;I clienti che hanno visualizzato questo prodotto hanno visto anche&quot;, &quot;I clienti che hanno acquistato questo prodotto hanno acquistato anche&quot;, &quot;Consigliato per te&quot; e così via. [Adobe AI](https://business.adobe.com/it/ai.html) potenzia Adobe Commerce Product Recommendations, che utilizza algoritmi di intelligenza artificiale e machine learning per eseguire un&#39;analisi approfondita dei dati aggregati degli acquirenti. Quando vengono combinati con il catalogo Commerce, questi dati offrono esperienze altamente coinvolgenti, pertinenti e personalizzate per l’acquirente.

>[!NOTE]
>
>Se la vetrina è implementata tramite PWA Studio, consulta la [documentazione di PWA](https://developer.adobe.com/commerce/pwa-studio/integrations/product-recommendations/). Scopri come integrare i consigli di prodotto in un ambiente [headless](headless.md) se utilizzi una tecnologia front-end personalizzata come React o Vue JS. Le istanze headless devono implementare l’evento per alimentare l’area di lavoro Product Recommendation.
...
Una volta installati e configurati, i moduli di consigli consentono alla vetrina di raccogliere dati comportamentali. Adobe AI combina questi dati con i dati del catalogo per calcolare le associazioni di prodotti utilizzate dal servizio Consigli. Puoi quindi creare, gestire e distribuire unità di consigli di prodotto direttamente dall’interfaccia utente di amministrazione.

...
Le note sulla versione descrivono gli aggiornamenti ai seguenti moduli [!DNL Product Recommendations]:
...
[Ulteriori informazioni sul supporto del prodotto](https://experienceleague.adobe.com/it/docs/commerce-operations/release/product-availability).
...
![Correzione](../assets/fix.svg) (**[!DNL Adobe Commerce as a Cloud Service]** soltanto) Aggiornamento del [pannello di anteprima del prodotto](create.md#preview-recommendations): ora viene visualizzato solo per i tipi di consigli che richiedono uno SKU per l&#39;anteprima (ad esempio, consigli basati su cross-selling, upselling e similarità). Per altri tipi, l’anteprima è nascosta. I tipi personalizzati come **Visualizzati di recente** e **Consigliati per te** mostrano un messaggio quando l&#39;anteprima non è supportata.

_19 febbraio 2026_

![Correzione](../assets/fix.svg) è stato risolto un problema a causa del quale i prodotti visualizzati nel tipo di consiglio _Visualizzato di recente_ venivano rimossi in un ordine imprevisto quando veniva raggiunto il limite di prodotti dell&#39;unità di consigli. I prodotti vengono ora rimossi in ordine FIFO (First-In, First-Out) in cui sono stati visualizzati.

_19 novembre 2025_

![Nuovo](../assets/new.svg) Ora puoi creare fino a 50 unità di consigli attive per ogni tipo di pagina. In precedenza, il limite era di cinque.
...
### 6.8.0 di magento/product-recommendations
...
![Nuovo](../assets/new.svg) aggiunta dipendenza al [dashboard di monitoraggio dello stato di sincronizzazione dei feed di dati](https://experienceleague.adobe.com/it/docs/commerce-admin/systems/data-transfer/data-sync/data-feed-sync-status). Questa dashboard consente di visualizzare in tempo reale informazioni sullo stato e sulle prestazioni dei feed di esportazione dei dati che trasferiscono i dati di prodotti e categorie da Commerce a servizi esterni, come Product Recommendations.
...
![Correzione](../assets/fix.svg) è stato migliorato il modo in cui le unità di consigli di prodotto interagiscono in ambienti diversi.
...
![Correzione](../assets/fix.svg) è stato risolto un problema intermittente che causava la scomparsa delle unità di consigli prodotto a causa di un errore di JavaScript quando i dati dell&#39;archivio locale non erano disponibili. Questa correzione assicura che PREX non generi più errori se `ds-view-history-time-decay` manca nell&#39;archiviazione locale.
...
![Correzione](../assets/fix.svg): miglioramenti apportati al pannello [consigli di anteprima](./create.md#preview-recommendations).
...
![Nuovo](../assets/new.svg) [!DNL Catalog Sync Dashboard] è ora [[!DNL Data Management Dashboard]](https://experienceleague.adobe.com/it/docs/commerce-admin/systems/data-transfer/data-sync/data-dashboard). Questo dashboard rinnovato fornisce informazioni approfondite sui flussi di dati per [!DNL Product Recommendations], [!DNL Live Search] e [!DNL Catalog Service].
...
![Correzione](../assets/fix.svg) è stato risolto un problema che causava il blocco errato di un cookie da parte di WAF (Web Application Firewall) di Fastly.
...
![Correzione](../assets/fix.svg) è stato risolto un problema che impediva la visualizzazione dell&#39;unità di consigli nella vetrina a causa di alcuni nomi di unità di consigli in Page Builder.
...
![Correzione](../assets/fix.svg) è stato risolto un problema che impediva l&#39;impostazione corretta del codice dell&#39;archivio quando si abilitava la configurazione &quot;Aggiungi codice dell&#39;archivio all&#39;URL&quot;.
...
![Nuovo](../assets/new.svg) Aggiunta la possibilità di [visualizzare in anteprima i risultati dei consigli](create.md) al momento della creazione. Questo aggiornamento richiede l’aggiornamento del modulo alla versione più recente.
![Nuovo](../assets/new.svg) Aggiunta la possibilità di [monitorare e gestire](https://experienceleague.adobe.com/it/docs/commerce/user-guides/data-services/catalog-sync) il processo di sincronizzazione del catalogo da parte dell&#39;amministratore.
...
![Correzione](../assets/fix.svg) è stato corretto l&#39;errore &quot;Impossibile recuperare i dati delle opzioni prodotto&quot; che si verificava durante l&#39;esportazione del catalogo.
...
* [Documentazione per gli sviluppatori](https://experienceleague.adobe.com/it/docs/commerce/product-recommendations/developer/development-overview)
